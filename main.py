print("=== LUX ARISTOKRAT MULTILANG ADMIN VERSION ===")
...
HOW_TEXT = {
    "ru": "ℹ️ Как получить баллы",
    "uz": "ℹ️ Ballarni qanday olish mumkin",
    "tj": "ℹ️ Чӣ тавр балл гирифтан мумкин",
    "en": "ℹ️ How to Get Points",
}
...
DISABLE_QR_TEXT = {
    "ru": "⛔️ Отключить QR",
    "uz": "⛔️ QR o‘chirish",
    "tj": "⛔️ QR-ро хомӯш кардан",
    "en": "⛔️ Disable QR",
}
ENABLE_QR_TEXT = {
    "ru": "✅ Включить QR",
    "uz": "✅ QR yoqish",
    "tj": "✅ QR-ро фаъол кардан",
    "en": "✅ Enable QR",
}
DELETE_QR_TEXT = {
    "ru": "🗑 Удалить QR",
...
UI = {
    ...
    "uz": {
        ...
        "bulk_prompt": "📥 <b>QRlarni ommaviy qo‘shish</b>\n\nBir xabarda ko‘p satr yuboring.\n\nFormatlar:\n<code>CODE</code>\n<code>CODE|Ball</code>\n<code>CODE|Nomi|Ball</code>\n\nFaqat CODE bo‘lsa — nom <b>QR CODE</b> va 10 ball bo‘ladi.\nAgar CODE|Ball bo‘lsa — nom <b>QR CODE</b> bo‘ladi.",
    ...
    "tj": {
        ...
        "bulk_prompt": "📥 <b>Иловаи гурӯҳии QR</b>\n\nЯк паём бо чанд сатр фиристед.\n\nФорматҳо:\n<code>CODE</code>\n<code>CODE|Балл</code>\n<code>CODE|Ном|Балл</code>\n\nАгар танҳо CODE бошад — ном <b>QR CODE</b> ва 10 балл мешавад.\nАгар CODE|Балл бошад — ном <b>QR CODE</b> мешавад.",
    ...
    "en": {
        ...
        "bulk_prompt": "📥 <b>Bulk QR upload</b>\n\nSend multiple lines in one message.\n\nFormats:\n<code>CODE</code>\n<code>CODE|Points</code>\n<code>CODE|Title|Points</code>\n\nIf only CODE is sent — title will be <b>QR CODE</b> and 10 points.\nIf CODE|Points is sent — title will be <b>QR CODE</b>.",
...
def main_kb(user_id: int) -> ReplyKeyboardMarkup:
    ...
    rows = [
        [KeyboardButton(text=SCAN_TEXT[lang], web_app=WebAppInfo(url=WEBAPP_URL))],
    ]
...
def qr_link_kb(code: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🔗 Open QR Link", url=build_qr_link(code))]
        ]
    )
...
async def choose_language_handler(message: Message):
    ...
    welcome = UI[language]["welcome"].format(
...
async def text_router(message: Message):
    ...
    if mode == "bulk_qr":
        ...
        for idx, line in enumerate(raw_lines, start=1):
            try:
                ...
                skipped.append(f"{idx}. {esc(str(e))}")
    ...
    if mode == "add_points":
        ...
        try:
            await bot.send_message(
                user_id,
                UI[get_lang(user_id)]["notify_add"].format(added=points, points=new_points, level=get_level(new_points))
            )
        except Exception:
            pass
        return
    ...
    if mode == "remove_points":
        ...
        try:
            await bot.send_message(
                user_id,
                UI[get_lang(user_id)]["notify_remove"].format(removed=points, points=new_points, level=get_level(new_points))
            )
        except Exception:
            pass
        return
